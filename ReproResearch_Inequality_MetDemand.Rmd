...
Create regional variables, following UN Statistics Division's classification: the M49 standard (https://unstats.un.org/unsd/methodology/m49/). Here, we scrape the webpage to get the data table of countries by geographic regions and tidy up the scraped data table.  
